...
\begin{itemize}
    ...
    \item \textbf{La modernisation du service public judiciaire} : développement des services numériques (e-justice), amélioration de l'accès à la justice, déploiement des programmes de réhabilitation des juridictions et de réduction des délais de traitement.
\end{itemize}
