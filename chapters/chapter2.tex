...
\begin{itemize}
    ...
    \item \textbf{Dimension man\'ageriale}~: un responsable de programme, d\'esign\'e par le ministre, est charg\'e de d\'efinir les objectifs, piloter la mise en \oe{}uvre et rendre compte des r\'esultats. Il constitue le sommet d'une pyramide de pilotage couvrant les niveaux central et d\'econcentr\'e.
...
\begin{itemize}
    \item Les \textbf{benchmarks na\"\i fs} (moyenne historique et lag-4)~: des r\'ef\'erences simples sans apprentissage statistique, qui fixent la barre minimale que tout mod\`ele ML doit d\'epasser pour justifier sa complexit\'e.

    \item La \textbf{r\'egression Lasso}~: mod\`ele lin\'eaire p\'enalis\'e, particulièrement adapt\'e aux d\'epenses de mat\'eriel o\`u les relations sont relativement stables et o\`u la parcimonie favorise l'interpr\'etabilit\'e.
