...
Pr\'evoir l'ex\'ecution budg\'etaire d'un minist\`ere suppose d'en ma\^{\i}triser le cadre. Ce chapitre d\'ecrit la structure du budget du Minist\`ere de la Justice, les r\`egles impos\'ees par la LOF~130-13, et le cycle de la d\'epense publique. Il aboutit sur les difficult\'es concr\`etes de pr\'evision qui motivent le recours \`a l'intelligence artificielle.
...
\begin{itemize}
    ...
    \item \textbf{La gestion ax\'ee sur les r\'esultats}~: chaque programme est associ\'e \`a des objectifs strat\'egiques et des indicateurs chiffr\'es, rendus publics dans les projets de performance (PdP) et les rapports annuels de performance (RAP) \citep{Abdelali2019, Khallouk2019}.
\end{itemize}
...
Le minist\`ere de la Justice dispose de quatre programmes budg\'etaires, dont la structure d\'etaill\'ee et l'\'evolution temporelle sont analys\'ees au chapitre~3.
...
Le \textbf{cr\'edit de paiement (CP)} repr\'esente la limite sup\'erieure des d\'epenses pouvant \^etre ordonnanc\'ees et pay\'ees au cours d'un exercice pour honorer les engagements pass\'es. Les CP constituent la traduction financi\`ere annuelle des CE, qui peuvent s'\'etaler sur plusieurs ann\'ees pour des projets pluriannuels. La dissociation CE/CP g\'en\`ere des \textit{restes \`a payer} (RAP), \`a savoir des CE engag\'es non encore couverts par des CP, dont la gestion constitue l'un des d\'efis majeurs de la tr\'esorerie de l'\'Etat \citep{Abdelali2019}.
...
la p\'eriode 2020--2025 et est pr\'esent\'e en d\'etail au chapitre~4.
...
La LOF exige des pr\'evisions sinc\`eres, triennales et align\'ees sur des indicateurs de performance publics. Le D\'ecret n\textsuperscript{o}~2-22-580 du 3~mars~2023 renforce cette exigence en instituant dans chaque d\'epartement minist\'eriel un dispositif de contr\^ole de gestion charg\'e de \og{}mesurer les \'ecarts entre les r\'ealisations et les pr\'evisions et d'analyser les causes et les cons\'equences des \'eventuels \'ecarts\fg{} (article~7) \citep{DecretCDG2023}. Or la pratique budg\'etaire au minist\`ere de la Justice r\'ev\`ele des \'ecarts persistants entre pr\'evisions initiales et r\'ealisations effectives. Plusieurs fragilit\'es structurelles les expliquent \citep{Abdelali2019}~:
...
Les insuffisances diagnostiqu\'ees dessinent un cahier des charges pr\'ecis pour des outils de pr\'evision alternatifs~: capacit\'e \`a capturer des dynamiques non lin\'eaires et des saisonnalit\'es marqu\'ees~; int\'egration de la dissociation CE/CP et des restes \`a payer~; r\'eactivit\'e face aux nouvelles informations~; et interpr\'etabilit\'e suffisante pour \^etre d\'efendable devant le MEF, le Parlement et la Cour des Comptes.

Les approches d'intelligence artificielle offrent des r\'eponses adapt\'ees \`a ces d\'efis, \`a condition d'\^etre s\'electionn\'ees en tenant compte des contraintes sp\'ecifiques du secteur public~: un mod\`ele qui pr\'edit mieux mais ne peut pas \^etre expliqu\'e est inutile dans ce contexte. Quatre mod\`eles seront \'evalu\'es au chapitre~3, selon un double crit\`ere de pr\'ecision et d'interpr\'etabilit\'e~:

\begin{itemize}
    \item Les \textbf{benchmarks na\"\i fs} (moyenne historique et d\'ecalage annuel)~: des r\'ef\'erences simples sans apprentissage statistique, qui fixent la barre minimale que tout mod\`ele ML doit d\'epasser pour justifier sa complexit\'e.

    \item La \textbf{r\'egression lin\'eaire r\'egularis\'ee} (Lasso, puis Ridge apr\`es validation)~: mod\`ele lin\'eaire p\'enalis\'e, particuli\`erement adapt\'e aux d\'epenses de mat\'eriel o\`u les relations sont relativement stables et o\`u la parcimonie favorise l'interpr\'etabilit\'e. La p\'enalit\'e $L_1$ du Lasso a d'abord \'et\'e retenue pour ses propri\'et\'es de s\'election automatique de variables~; l'analyse post-validation a conduit \`a lui substituer une p\'enalit\'e $L_2$ (Ridge), plus stable sur les configurations \`a faible effectif (cf.~\S4.5.5).

    \item \textbf{XGBoost} (gradient boosting par arbres)~: capable de capturer des relations non lin\'eaires et des effets de seuil, particulièrement performant sur les d\'epenses d'investissement \`a forte variabilit\'e.
\end{itemize}

Les deux mod\`eles ML sont \'evalu\'es selon un protocole de validation walk-forward \`a fen\^etre expansive, seul protocole garantissant qu'aucune information future ne contamine l'entra\^\i nement. Le chapitre~3 d\'eveloppe les fondements th\'eoriques de ces mod\`eles et justifie les choix m\'ethodologiques retenus.
